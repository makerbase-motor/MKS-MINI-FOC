// MKS MINI FOC Stepper Motor Open Loop Velocity Example; Test Library：SimpleFOC 2.2.1; Test Hardware：MKS MINI FOC V1.0;
...
StepperDriver4PWM driver = StepperDriver4PWM(32, 33, 26, 27, 22, 21); 
