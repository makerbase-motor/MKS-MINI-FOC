/*
MKS MINI FOC Closed Loop Position Torque Mutual Control Example; Test library：SimpleFOC 2.1.1; Test Hardware：MKS MINI FOC V1.0
...
BLDCDriver3PWM driver1 = BLDCDriver3PWM(26, 27, 14, 21);    //Also modify the value of BLDCMotor() here
